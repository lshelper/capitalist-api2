...
# MALAYSIA_BANK payment
capitalist_api2_create_payment_malaysia_bank() {
  local user_request_id="${1:-malaysia-bank-$(capitalist_api2_now_ms)}"
  ...
  capitalist_api2_create_payment_json "$(cat <<JSON
{
  ...
  "comment": "MALAYSIA_BANK payout example",
  "payload": {
    "type": "MALAYSIA_BANK",
    "destination": {
      "bankCode": "MBBEMYKL",
