...
# WORLDCARDEUR payment
capitalist_api2_create_payment_worldcard() {
  local user_request_id="${1:-worldcardeur-$(capitalist_api2_now_ms)}"
  ...
  capitalist_api2_create_payment_json "$(cat <<JSON
{
  ...
  "comment": "WORLDCARDEUR payout example",
  "payload": {
    "type": "WORLDCARDEUR",
