...
# USDTTRC20 payment
capitalist_api2_create_payment_usdttrc20() {
  local user_request_id="${1:-usdttrc20-$(capitalist_api2_now_ms)}"
  ...
  capitalist_api2_create_payment_json "$(cat <<JSON
{
  ...
  "comment": "USDTTRC20 payout example",
  "payload": {
    "type": "USDTTRC20",
    "account": "T0000000000000000000000000000000000"
  }
}
JSON
)"
