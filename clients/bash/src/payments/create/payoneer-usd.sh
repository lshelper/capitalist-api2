...
# PAYONEER_USD payment
capitalist_api2_create_payment_payoneer_usd() {
  local user_request_id="${1:-payoneer-usd-$(capitalist_api2_now_ms)}"
  ...
  capitalist_api2_create_payment_json "$(cat <<JSON
{
  ...
  "comment": "PAYONEER_USD payout example",
  "payload": {
    "type": "PAYONEER_USD",
